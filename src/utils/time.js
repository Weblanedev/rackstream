...
/**
 * Calculates and returns the remaining time parts (days, hours, minutes, seconds)
 * until a specified future date and time. It also updates the current time every
 * second using a state variable.
 *
 * @param {string | Date} endDateTime - The future date and time to count down to.
 * @returns {Object} An object containing the time parts: days, hours, minutes, and seconds.
 */
